...
class CentTests: XCTestCase {
    ...
    func testDateMath() {
        ...
        let tests = [
            TestDate(unit: NSCalendarUnit.Second, singleMath: 1.second, multipleMath: multiple.seconds),
            TestDate(unit: NSCalendarUnit.Minute, singleMath: 1.minute, multipleMath: multiple.minutes),
            TestDate(unit: NSCalendarUnit.Hour, singleMath: 1.hour, multipleMath: multiple.hours),
            TestDate(unit: NSCalendarUnit.Day, singleMath: 1.day, multipleMath: multiple.days),
            TestDate(unit: NSCalendarUnit.WeekOfYear, singleMath: 1.week, multipleMath: multiple.weeks),
            TestDate(unit: NSCalendarUnit.Month, singleMath: 1.month, multipleMath: multiple.months),
            TestDate(unit: NSCalendarUnit.Year, singleMath: 1.year, multipleMath: multiple.years)
        ]
